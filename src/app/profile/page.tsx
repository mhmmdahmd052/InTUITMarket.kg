               ...
               <div className="bg-surface-container-low p-4 rounded-[40px] border border-outline-variant/10 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="space-y-3 pt-6 border-t border-outline-variant/10">
                      <Link href="/settings" className="w-full flex items-center justify-center gap-2 bg-surface-container-highest hover:bg-surface-container text-on-surface text-xs font-black uppercase tracking-widest py-3 rounded-[16px] border border-outline-variant/10 transition-all active:scale-95">
                        <span className="material-symbols-outlined text-base">settings</span>
                        {t("settings.accountSettings")}
                      </Link>
                      <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 bg-error/5 hover:bg-error/10 text-error text-xs font-black uppercase tracking-widest py-3 rounded-[16px] border border-error/10 transition-all active:scale-95">
            ...
            <section className="lg:col-span-8 space-y-6">
               <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                     <Link href="/orders" className="p-4 bg-surface-container-low hover:bg-surface-container-high border border-outline-variant/10 rounded-2xl group transition-all hover:shadow-xl relative overflow-hidden flex flex-col items-center text-center">
                        ...
                        <p className="text-sm text-secondary font-medium leading-tight relative z-10 opacity-70">{t("profile.ordersDesc")}</p>
                     </Link>

                     <Link href="/support" className="p-4 bg-surface-container-low hover:bg-surface-container-high border border-outline-variant/10 rounded-2xl group transition-all hover:shadow-xl relative overflow-hidden flex flex-col items-center text-center">
                        <div className="absolute top-0 right-0 w-16 h-16 bg-primary/5 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                        ...
                        <p className="text-sm text-secondary font-medium leading-tight relative z-10 opacity-70">{t("profile.supportDesc")}</p>
                     </Link>

                     <Link href="/products" className="p-4 bg-surface-container-low hover:bg-surface-container-high border border-outline-variant/10 rounded-2xl group transition-all hover:shadow-xl relative overflow-hidden flex flex-col items-center text-center">
                        <div className="absolute top-0 right-0 w-16 h-16 bg-primary/5 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                        ...
                        <p className="text-sm text-secondary font-medium leading-tight relative z-10 opacity-70">{t("profile.catalogDesc")}</p>
                     </Link>
